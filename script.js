...
//     var li = document.createElement("li");
//     li.appendChild(document.createTextNode(input.value));
//     addListItemClickEvent(li);
//     createListItemDeleteButton(li);
//     ul.appendChild(li);
//     input.value = "";
// }
...
//         addListItemClickEvent(listItems[i]);
//     }
// }

// function addListItemClickEvent(listItem) {
//     listItem.addEventListener("click", listDoneAfterclick)
// }

// function listDoneAfterclick(event) {
//     event.target.classList.toggle("done");
// }

// function createListItemDeleteButton(listItem) {
...
//     listItems = ul.getElementsByTagName("li");
//     for (var i = 0; i < listItems.length; i++) {
//         createListItemDeleteButton(listItems[i]);
//     }
// }
